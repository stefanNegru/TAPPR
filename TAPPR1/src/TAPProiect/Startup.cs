    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(null, "Blogs/Create", new { area = "BlogArea", controller = "Blogs", action = "CreateBlog" });
                endpoints.MapControllerRoute(null, "Blogs/Index", new { area = "BlogArea", controller = "Blogs", action = "Index" });
                endpoints.MapControllerRoute(null, "Blogs/Edit", new { area = "BlogArea", controller = "Blogs", action = "Edit" });
                endpoints.MapControllerRoute(null, "Blogs/Delete", new { area = "BlogArea", controller = "Blogs", action = "DeleteBlog" });
                endpoints.MapControllerRoute(null, "Blogs/View", new { area = "BlogArea", controller = "Blogs", action = "ViewBlog" });
                endpoints.MapControllerRoute(null, "AllBlogs/View", new { area = "BlogArea", controller = "Blogs", action = "AllBlogs" });

                endpoints.MapControllerRoute(null, "Blogs/UserBlogs", new { area = "BlogArea", controller = "Blogs", action = "UserBlogs" });

                endpoints.MapControllerRoute(null, "Comment/Create", new { area = "CommentsArea", controller = "Comments", action = "Create" });
                ...
                endpoints.MapControllerRoute(name: null, pattern: "exemplu/Customers/Create", new { area = "exemplu", controller = "Customers", action = "Create" });
